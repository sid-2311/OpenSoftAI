  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[90vh] bg-[#0B0417] text-white flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute right-0 top-0 bottom-0 w-full bg-center bg-no-repeat">
            <Image
              ...
              alt="Restaurant Management System Development"
              fill
        ...
        {/* Content */}
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-12 py-16 sm:py-20 flex flex-col md:flex-row items-center text-center md:text-left">
          {/* Left side content */}
          <div className="w-full md:w-1/2 space-y-4">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-snug md:leading-tight">
              Restaurant Management System Development – Streamline Every
          ...
          {/* Right placeholder for spacing (desktop only) */}
