...
import { Users, MessageCircle, LineChart, Calendar, FolderOpen, ArrowRight, Sparkles } from 'lucide-react';
...
export default function CRMCTASection() {
  ...
  const ctaButtons = [
    {
      icon: Calendar,
      title: 'Schedule Your CRM Strategy Session',
      description: 'Plan your CRM transformation',
      gradient: 'from-blue-500 to-blue-700'
    },
    {
      icon: MessageCircle,
      title: 'Discuss Your Sales Process',
      description: 'Talk with our CRM experts',
      gradient: 'from-blue-600 to-blue-800'
    },
    {
      icon: FolderOpen,
      title: 'View Our CRM Portfolio',
      description: 'Explore real client solutions',
        ...
        >
          ...
          <div className="relative p-12 pb-8">
            ...
            <p className="text-xl text-blue-100 text-center max-w-3xl mx-auto leading-relaxed mb-4">
              The fastest-growing companies aren’t just product-driven — they’re relationship-driven.
              Our custom CRM systems help you manage and strengthen those relationships at scale.
            </p>

            <p className="text-lg text-blue-200 text-center max-w-3xl mx-auto leading-relaxed">
              Build a CRM that your sales team will actually love using — one that turns leads into customers,
              and customers into long-term advocates.
            </p>
          </div>
