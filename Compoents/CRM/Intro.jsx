...
export default function CRMSection() {
  ...
  const [radius, setRadius] = useState(170); // ✅ Safe default
  ...
  return (
    <section className="relative bg-gradient-to-b from-white via-blue-50 to-white py-16 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 right-10 w-64 sm:w-96 h-64 sm:h-96 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"
          ...
          >
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-blue-100">
              ...
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
                ...
                The real problem is that most CRMs are built for{" "}
