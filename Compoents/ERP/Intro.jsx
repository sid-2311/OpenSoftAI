          ...
          <div className={`transition-all duration-1000 delay-200 transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-blue-100">
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                ...
                <span className="font-semibold text-blue-600">central nervous system</span> of your business, 
                connecting finance, HR, inventory, sales, and operations into one integrated platform.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                At <span className="font-semibold text-blue-700">OpenSoft AI</span>, we build custom ERP solutions 
                that eliminate data silos, reduce manual work, and provide the insights you need to make informed 
                business decisions.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                Our ERP development approach focuses on your{' '}
                <span className="font-semibold text-blue-600">specific business processes</span> rather than 
                forcing you to adapt to rigid software structures. The result is an ERP system that enhances 
                productivity, improves accuracy, and scales with your business growth.
              </p>
            </div>
          </div>
            ...
            <div className="relative h-96 flex items-center justify-center">
              ...
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-20 h-20 bg-gradient-to-br ${feature.color} rounded-full flex items-center justify-center shadow-lg cursor-pointer transform transition-all duration-300 hover:scale-110 ${isActive ? 'ring-4 ring-blue-300' : ''}`}>
                      <Icon className="w-8 h-8 text-white" />
                    </div>
                    <div className={`absolute top-full mt-2 left-1/2 transform -translate-x-1/2 whitespace-nowrap transition-opacity duration-300 ${isActive ? 'opacity-100' : 'opacity-0'}`}>
