          ...
          >
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-blue-100">
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-6">
                ...
                of your business, connecting finance, HR, inventory, sales, and
                operations into one integrated platform.
              </p>
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-6">
                At{" "}
              ...
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                ...
                The result is an ERP system that enhances productivity, improves
                accuracy, and scales with your business growth.
              </p>
            </div>
          </div>

          {/* Right Side - Animated Orbiting Features */}
          <div
