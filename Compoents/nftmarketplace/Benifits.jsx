    ...
    <section className="relative bg-white py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mt-20 text-center">
          <Link href="/contact-us" className="inline-flex items-center px-10 py-5 bg-gradient-to-r from-blue-600 to-blue-500 text-white text-lg font-bold rounded-2xl shadow-xl hover:shadow-2xl hover:from-blue-700 hover:to-blue-600 transition-all duration-300 transform hover:-translate-y-1">
