...
export default function InboundOutboundAgentsSection() {
  ...
  const inboundAdvantages = [
    ...
    { icon: <Shield className="w-6 h-6" />, title: "Consistent Service Quality", desc: "Same high-level support whether it’s your first call or thousandth" },
    { icon: <TrendingUp className="w-6 h-6" />, title: "Intelligent Escalation", desc: "Complex issues seamlessly transferred to human agents with context" },
  ...
  const outboundBenefits = [
    { icon: <TrendingUp className="w-6 h-6" />, title: "Massive Scale", desc: "Make hundreds of calls simultaneously without extra hires" },
    ...
    { icon: <Clock className="w-6 h-6" />, title: "Intelligent Timing", desc: "AI learns optimal calling times for different segments" },
    { icon: <BarChart3 className="w-6 h-6" />, title: "Detailed Analytics", desc: "Track conversion rates, call outcomes, and opportunities" },
  ];

  return (
    <section
      className="relative bg-gradient-to-b from-white to-blue-50 py-20 sm:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden"
      aria-labelledby="ai-agents-section"
    >
      <h2 id="ai-agents-section" className="sr-only">
        AI Inbound and Outbound Calling Agents
      </h2>

      {/* Background */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(59,130,246,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(59,130,246,0.03)_1px,transparent_1px)] bg-[size:50px_50px]" />
      <div className="absolute top-20 left-10 w-64 sm:w-96 h-64 sm:h-96 bg-blue-400 rounded-full blur-3xl opacity-10" />
  ...
  return (
    <div className="space-y-12 sm:space-y-16 animate-fade-in">
      <div className="text-center px-4">
        <div className="inline-flex items-center justify-center w-16 sm:w-20 h-16 sm:h-20 bg-blue-600 rounded-3xl mb-6 shadow-lg shadow-blue-500/30">
          <PhoneIncoming className="w-8 sm:w-10 h-8 sm:h-10 text-white" />
        </div>
        <h3 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-4 leading-tight">
      ...
      <div>
        <h4 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {capabilities.map((item, i) => (
            <div
              key={i}
              className="group bg-white rounded-2xl p-5 sm:p-6 border border-blue-100 hover:border-blue-300 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
              <div className="w-10 sm:w-12 h-10 sm:h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 mb-3 sm:mb-4 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                {item.icon}
              </div>
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 lg:p-12 border border-blue-100 shadow-xl">
        <h4 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 flex items-center gap-2 sm:gap-3">
          <CheckCircle className="w-6 sm:w-8 h-6 sm:h-8 text-blue-600" /> The Inbound Advantage:
        </h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
          {advantages.map((item, i) => (
            <div
              key={i}
              className="flex items-start gap-3 sm:gap-4 bg-gradient-to-br from-blue-50 to-white rounded-2xl p-5 sm:p-6 border border-blue-100 hover:border-blue-300 transition-all duration-300"
            >
              <div className="w-10 sm:w-12 h-10 sm:h-12 bg-blue-600 rounded-xl flex items-center justify-center text-white flex-shrink-0 shadow-md">
                {item.icon}
              </div>
              <div>
                <h5 className="text-base sm:text-lg font-bold text-gray-900 mb-1 sm:mb-2">{item.title}</h5>
                <p className="text-sm text-gray-600">{item.desc}</p>
              </div>
            </div>
          ))}
...
function OutboundSection({ useCases, benefits }) {
  return (
    <div className="space-y-12 sm:space-y-16 animate-fade-in">
      <div className="text-center px-4">
        <div className="inline-flex items-center justify-center w-16 sm:w-20 h-16 sm:h-20 bg-blue-600 rounded-3xl mb-6 shadow-lg shadow-blue-500/30">
          <PhoneOutgoing className="w-8 sm:w-10 h-8 sm:h-10 text-white" />
        </div>
        <h3 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-4 leading-tight">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 lg:p-12 border border-blue-100 shadow-xl">
        <h4 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 flex items-center gap-2 sm:gap-3">
          <CheckCircle className="w-6 sm:w-8 h-6 sm:h-8 text-blue-600" /> Outbound Benefits:
        </h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
          {benefits.map((item, i) => (
            <div
