...
export default function CTASection() {
  const contactMethods = [
    {
      ...
      subtitle: "Talk to someone who's actually built these systems",
      action: "+1 (000) 000-1111",
      href: "tel:+10000001111",
      color: "blue"
    },
    {
      icon: Mail,
      title: "Email Your Challenge",
      subtitle: "Share your biggest customer service challenge",
      action: "chatbot-ai@opensoftai.com",
      href: "mailto:chatbot-ai@opensoftai.com",
      color: "indigo"
    },
    {
      icon: Calendar,
      title: "Book a Demo",
      subtitle: "See what a chatbot built for your business would look like",
      action: "Schedule Now",
      href: "#book-demo",
      color: "sky"
    }
  ...
  const benefits = [
    { icon: Clock, text: "30-day pilot program" },
    { icon: Zap, text: "Results within 2 weeks" },
    { icon: Shield, text: "Try before you commit" }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Let's Build Something That Actually Helps Your Customers
          </h2>
          <div className="max-w-3xl mx-auto space-y-4 text-lg text-gray-700">
            <p>
              Here's the deal—you already know if your customer communications could use help. You either have too many repetitive inquiries eating up your team's time, or you're missing opportunities because people can't get quick answers to simple questions.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-12 shadow-2xl mb-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-blue-100 text-lg text-center mb-8 leading-relaxed">
              We offer a 30-day pilot program where you can test a custom chatbot with real customers. Most businesses see measurable results within the first two weeks.
            </p>
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div key={index} className="flex items-center gap-3 bg-blue-700 bg-opacity-50 rounded-xl p-4">
                    <Icon className="w-6 h-6 text-blue-200 flex-shrink-0" />
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-blue-100 mb-12">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              That customer trying to return the shirt I mentioned at the beginning? With the right chatbot, she would have had her return processed and a replacement ordered before she finished her coffee.
            </p>
            <p className="text-xl font-semibold text-gray-900">
              Your customers deserve better than frustrating bot conversations. Let's build them something that actually works.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-gray-900 to-blue-900 rounded-3xl p-12 shadow-2xl text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to stop losing customers to bad chatbot experiences?
          </h3>
          <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
            Schedule your free chatbot strategy session or call us directly. Your next conversation could be the one that changes how your customers experience your business.
          </p>
