  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 sm:hidden bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900">
        <div className="absolute -top-16 -left-16 w-56 h-56 bg-indigo-500/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-56 h-56 bg-purple-500/10 rounded-full blur-2xl" />
      </div>

      {/* DESKTOP IMAGE */}
      <div className="absolute inset-0 z-0 hidden sm:block">
        <Image
          src={heroData.backgroundImage || "/images/ai-chatbot-cta1.jpg"}
