          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-blue-50 to-white border border-blue-200 rounded-2xl p-6 shadow-lg shadow-blue-500/10">
                ...
                <div className="ml-6">
                  <p className="text-gray-700 leading-relaxed mb-4">
                    ...
                    e-commerce chatbot. After fifteen minutes of circular
                    conversations and increasing frustration, she gave up and called
                    customer service. The irony? That chatbot was supposed to save
                    the company money on support calls.
                  </p>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                been building chatbots that *actually help* for over six years. The
                difference between a chatbot that works and one that drives
                customers crazy usually comes down to{" "}
                <span className="font-semibold">understanding context</span>. Real
                conversations aren’t scripted — people switch topics, ask weird
                questions, and expect the bot to keep up. That’s exactly what we
                design for.
              </p>
