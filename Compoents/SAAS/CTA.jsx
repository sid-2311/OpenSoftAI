...
export default function SaaSCTASection() {
  ...
  const ctaButtons = [
    {
      icon: Calendar,
      title: "Schedule Your SaaS Strategy Session",
      description: "Talk with our SaaS experts",
      gradient: "from-indigo-500 to-indigo-700",
    },
    {
      icon: MessageCircle,
      title: "Discuss Your SaaS Idea",
      description: "Let's shape your product vision",
      gradient: "from-indigo-600 to-indigo-800",
    },
    {
      icon: FolderOpen,
      title: "View Our SaaS Portfolio",
      description: "Explore successful projects",
        ...
        >
          ...
          <div className="relative p-12 pb-8">
            ...
            <p className="text-md text-indigo-100 text-center max-w-3xl mx-auto leading-relaxed mb-4">
              The SaaS model is powerful when executed well — but unforgiving
              when built poorly. The difference between a platform that thrives
              and one that fails often comes down to the early development
              decisions.
            </p>

            <p className="text-md text-indigo-200 text-center max-w-3xl mx-auto leading-relaxed">
              Build SaaS software that customers love and subscribe to for the
              long term. Let’s create your platform with great UX and a
          ...
          <div className="p-12 pt-10">
            <div className="text-center mb-10">
              <p className="text-2xl text-white font-semibold mb-2">
                Let’s talk about your SaaS vision.
              </p>
