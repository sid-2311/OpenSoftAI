              ...
              >
                ...
                >
                  ...
                  <div className="relative mb-6">
                    ...
                    >
                      <DynamicIcon name={reason.icon} className="w-6 h-6 text-white" />
                    </div>
                  ...
                  >
                    ...
                    <DynamicIcon name={reason.arrowIcon || "ArrowRight"} className="w-5 h-5" />
                  </div>
                </div>
              </div>
            );
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid md:grid-cols-3 gap-8 items-center">
                ...
                <div className="flex justify-center md:justify-end">
                  <Link href={bottomCta.button?.link || "/contact-us"} className="group bg-white text-blue-700 px-8 py-4 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-3">
                    <span>{bottomCta.button?.label || "Get Started"}</span>
                    <DynamicIcon name={bottomCta.button?.icon || "ArrowRight"} className="w-5 h-5 group-hover:translate-x-2 transition-transform duration-300" />
                  </Link>
                </div>
              </div>
            </div>
