    ...
    >
      ...
      <div className="bg-[#0B2542] rounded-2xl shadow-xl p-6 md:p-10 w-full max-w-6xl">
        ...
        <nav
          ...
          className="flex overflow-x-auto mt-1 scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-blue-100 justify-start gap-4 mb-8 pb-2 -mx-4 px-4 no-scrollbar"
        >
