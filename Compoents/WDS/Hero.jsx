      ...
      <section className="relative w-full min-h-[90vh] bg-[#0B0417] text-white flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute right-0 top-0 bottom-0 w-full bg-center bg-no-repeat">
            <Image
              src={section.backgroundImage || "/images/web development.webp"}
              alt={section.title || "Website Development Services"}
              fill
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 py-20 flex flex-col md:flex-row items-center text-center md:text-left">
          <div className="w-full md:w-1/2 space-y-6">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
              {section.title || "Website Development Services —"}
              <span className="block">{section.subtitle || "From Static Sites to Scalable eCommerce Platforms"}</span>
            </h1>

            <p className="text-gray-300 text-sm sm:text-base md:text-lg">
              {section.description || "Build fast, secure, and scalable websites that bring your vision online. Whether it’s a portfolio, business site, or a full eCommerce platform — we deliver."}
            </p>
