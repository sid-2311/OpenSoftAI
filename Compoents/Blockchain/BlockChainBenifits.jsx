...
export default function BlockchainBenefits({ data }) {
  const benefitsSection = data?.blockchainBenefitsSection || {};
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-16">
          ...
          >
            {benefitsSection.header?.title || "The Business Benefits That Drive Real Value"}
          </h2>
          {benefitsSection.header?.divider !== false && <div className="w-24 h-1 bg-blue-600 mx-auto"></div>}
        </header>
