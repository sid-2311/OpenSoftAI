...
export default function AppTypesSection({ data }) {
  const [activeIndex, setActiveIndex] = useState(0);

  // Extract section data
  const section = data?.appTypes || {};
  ...
  const appTypes = typesData.map(type => ({
    icon: iconMap[type.icon] || Smartphone,
    title: type.title,
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-white py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
            ...
            return (
              ...
              >
                ...
                <div className="relative px-6 md:px-12 flex items-start gap-6 md:gap-12">
                  {/* Number */}
                  <div
                    className={`flex-shrink-0 text-3xl md:text-4xl font-bold transition-all duration-500 ${activeIndex === index
                        ? "text-blue-200"
                        : "text-blue-300/40"
                      }`}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-4 mb-3">
                      <div
                        className={`flex-shrink-0 w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-500 ${activeIndex === index
                      ...
                      <h2
                        className={`text-2xl md:text-3xl font-bold transition-all duration-500 ${activeIndex === index ? "text-white" : "text-slate-900"
                          }`}
                      >
                        {type.title}
                      </h2>
                  ...
                  {/* Arrow Indicator */}
                  <div
                    className={`flex-shrink-0 transition-all duration-500 ${activeIndex === index
        ...
        <div className="mt-24 flex flex-col md:flex-row items-center justify-center gap-6">
          <Link
            href={bottomCta.primary?.link || "/contact-us"}
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              {bottomCta.primary?.label || "Start Your App Project"}
          ...
          <Link
            href={bottomCta.secondary?.link || "/portfolio"}
