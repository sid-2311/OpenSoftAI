      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-blue-800/50 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-blue-400/20">
          <p className="text-md md:text-lg text-blue-50 leading-relaxed">
            Our team of <span className="font-bold text-white text-lg md:text-xl">25+ certified AI engineers</span> has seen what works, what doesn't, and what makes the difference between AI that impresses in demos and AI that delivers results every single day.
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl p-6 transform hover:-translate-y-2 transition-all duration-300 shadow-xl">
              <div className="text-3xl font-bold text-blue-600 mb-3">300+</div>
            ...
            <div className="bg-white rounded-xl p-6 transform hover:-translate-y-2 transition-all duration-300 shadow-xl">
              <div className="text-3xl font-bold text-blue-700 mb-3">5+</div>
              <p className="text-gray-700 font-medium leading-snug">
            ...
            <div className="bg-white rounded-xl p-6 transform hover:-translate-y-2 transition-all duration-300 shadow-xl">
              <div className="text-3xl font-bold text-blue-800 mb-3">95%</div>
              <p className="text-gray-700 font-medium leading-snug">
            ...
            <div className="bg-white rounded-xl p-6 transform hover:-translate-y-2 transition-all duration-300 shadow-xl">
              <div className="text-3xl font-bold text-blue-900 mb-3">10+</div>
              <p className="text-gray-700 font-medium leading-snug">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-10 border border-blue-400/30">
            <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Beyond The Numbers</h3>
          ...
          <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl p-10 shadow-2xl">
            <h3 className="text-xl md:text-2xl font-bold text-white mb-4">A Decade of Learning</h3>
