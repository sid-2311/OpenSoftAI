...
export default function POSCTASection() {
  ...
  const ctaButtons = [
    {
      icon: CalendarCheck2,
      title: 'Schedule Your POS Consultation',
      description: 'Talk with our experts to discuss your POS needs',
      gradient: 'from-blue-500 to-blue-700'
    },
    {
      icon: ShoppingBag,
      title: 'Request a System Demo',
      description: 'See our POS in action and explore key features',
      gradient: 'from-blue-600 to-blue-800'
    },
    {
      icon: FileBarChart,
      title: 'View POS Case Studies',
      description: 'See how we helped businesses modernize sales',
        ...
        >
          ...
          <div className="relative p-12 pb-8">
            ...
            <p className="text-md text-blue-100 text-center max-w-3xl mx-auto leading-relaxed mb-4">
              The right POS system becomes the central hub of your business — connecting sales, inventory, customers, and analytics into one powerful platform.
            </p>

            <p className="text-md text-blue-200 text-center max-w-3xl mx-auto leading-relaxed">
              Modern POS technology provides the foundation for business growth and a strong competitive advantage.
            </p>
          </div>
