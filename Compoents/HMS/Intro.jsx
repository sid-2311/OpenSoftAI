...
import { Stethoscope, HeartPulse, Hospital, ClipboardCheck, Activity, ShieldCheck } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-blue-100">
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                Healthcare providers face increasing pressure to deliver quality patient care while managing complex administrative requirements and regulatory compliance. 
                Our <span className="font-semibold text-blue-600">Hospital Management Systems</span> integrate all aspects of healthcare operations into a unified platform that 
                improves patient outcomes, reduces administrative burden, and ensures regulatory compliance.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                <span className="font-semibold text-blue-700">OpenSoft AI</span>'s healthcare software solutions are designed by understanding real-world healthcare workflows 
                and challenges. We build systems that support <span className="font-semibold text-blue-600">clinical decision-making</span> while simplifying administrative processes 
          ...
          >
            <div className="relative h-96 flex items-center justify-center">
              ...
              {features.map((feature, index) => {
                ...
                const radius = 170; // 🔹 Increased spacing between icons and center
        ...
        >
          <button className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-800 text-white font-semibold rounded-full shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden">
            <span className="relative z-10">Get Your Custom HMS Solution</span>
