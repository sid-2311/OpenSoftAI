...
import { Stethoscope, Calendar, FileText, ArrowRight, HeartPulse } from 'lucide-react';
import Link from 'next/link';

export default function HMSCTASection() {
  ...
  const ctaButtons = [
    {
      icon: Calendar,
      title: 'Schedule Your Healthcare Technology Consultation',
      description: 'Talk to our healthcare experts',
      gradient: 'from-blue-500 to-blue-700'
    },
    {
      icon: Stethoscope,
      title: 'Request a System Demo',
      description: 'See our HMS in action',
      gradient: 'from-blue-600 to-blue-800'
    },
    {
      icon: FileText,
      title: 'View Healthcare Case Studies',
      description: 'Explore real success stories',
        ...
        >
          ...
          <div className="relative p-12 pb-8">
            ...
            <p className="text-md text-blue-100 text-center max-w-3xl mx-auto leading-relaxed mb-4">
              Modern healthcare requires technology that enhances both clinical excellence and operational efficiency.
            </p>

            <p className="text-md text-blue-200 text-center max-w-3xl mx-auto leading-relaxed">
              The right hospital management system empowers healthcare professionals to deliver exceptional patient care while ensuring financial sustainability.
            </p>
          </div>
