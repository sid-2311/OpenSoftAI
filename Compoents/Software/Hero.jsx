  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 sm:hidden bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900">
        ...
        <div className="absolute -top-20 -left-20 w-60 h-60 bg-indigo-600/20 rounded-full blur-3xl"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          <div className="max-w-xl md:max-w-2xl">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-8 sm:mb-10 leading-relaxed">
              Build software that grows with your business. OpenSoftAI delivers
              custom web, mobile, and enterprise software solutions designed for
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-black/80 to-transparent z-10 hidden sm:block"></div>
    </section>
  );
}
